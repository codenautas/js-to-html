...
(function (factory) {
    ...
    var HtmlBase = /** @class */ (function () {
        ...
        HtmlBase.prototype.attributesToHtmlText = function () {
            ...
            return Object.keys(this.attributes).map(function (attrName) {
                ...
                var attrDefinition = exports.htmlAttributes[attrName] || {};
        ...
        HtmlBase.prototype.contentToHtmlText = function (opts, recurseOpts) {
            return internalArrayToHtmlText(this.content, opts, { margin: recurseOpts.margin + 2 });
        };
        HtmlBase.prototype.toHtmlDoc = function (opts, recurseOpts) {
            opts = opts || {};
            var target = this;
            if (!opts.incomplete) {
                var source = this;
    ...
    var Html = /** @class */ (function (_super) {
        ...
        function Html(directObject) {
            return _super.call(this, directObject, validDirectProperties.tagName.properties) || this;
        }
        Html.prototype.toHtmlText = function (opts, recurseOpts) {
            ...
            var tagInfoFirstChild = (this.content.length && 'tagName' in this.content[0]) ? exports.htmlTags[this.content[0].tagName] : {};
    ...
    var HtmlTextNode = /** @class */ (function (_super) {
        ...
        function HtmlTextNode(directObject) {
            return _super.call(this, directObject, validDirectProperties.textNode.properties) || this;
        }
    ...
    var HtmlDirectNode = /** @class */ (function (_super) {
        ...
        function HtmlDirectNode(directObject) {
            return _super.call(this, directObject, validDirectProperties.htmlCode.properties) || this;
        }
        HtmlDirectNode.prototype.toHtmlText = function () {
    ...
    var HtmlComment = /** @class */ (function (_super) {
        ...
        function HtmlComment(directObject) {
            return _super.call(this, directObject, validDirectProperties.commentText.properties) || this;
        }
        HtmlComment.prototype.toHtmlText = function () {
    ...
    Object.keys(exports.htmlTags).map(function (tagName) {
        // ok.map(function(tagName){    
        exports.html[tagName] = function (contentOrAttributes, contentIfThereAreAttributes) {
